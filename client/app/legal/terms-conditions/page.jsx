...
export const metadata = {
  title: "Terms and Conditions | GolfMini",
  description:
    "GolfMini Terms and Conditions. Read our terms and conditions before using our service.",
};

export default function Page() {
  return (
    <div className={styles.termsContainer}>
      <h1>GolfMini - Terms and Conditions</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to GolfMini.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to GolfMini, accessible from{" "}
            <a
              href="https://golfmini.com"
      ...
      <ul>
        <li>By email: legal@golfmini.com</li>
      </ul>
    </div>
  );
}
